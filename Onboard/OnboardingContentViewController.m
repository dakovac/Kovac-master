...
static NSString * const kDefaultOnboardingFont = @"Helvetica-Bold";

#define DEFAULT_TEXT_COLOR [UIColor colorWithRed:225/255.0f green:160.0f/255.0f blue:65/255.0f alpha:1.0f ];
...
static CGFloat const kDefaultTitleFontSize = 25;
static CGFloat const kDefaultBodyFontSize = 18;
static CGFloat const kDefaultButtonFontSize = 25;
...
//    self.titleLabel.frame = CGRectMake(0, 0, self.view.frame.size.width, 40);
    ...
    if (buttonText) {
        ...
        [self.actionButton setBackgroundColor:[UIColor colorWithRed:225/255.0f green:160.0f/255.0f blue:65/255.0f alpha:1.0f ]];
...
- (void)viewWillLayoutSubviews {
    ...
    [self.iconImageView setFrame:CGRectMake((viewWidth / 2.0) - (self.iconWidth / 2.0)-38, self.topPadding+180, self.iconWidth+70, self.iconHeight+100)];

    CGFloat titleYOrigin = 50;
